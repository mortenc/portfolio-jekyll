...
As Creative Director and Lead Designer on the project I led all discovery, strategy, UX/UI design and prototyping activities on the project. Besides me, the project team included an additional UI Designer/Prototyper and a Project Manager.
...
{% comment %}
{% include project-image.html type="grid" file="ggb-discovery-reports.jpg" caption="The key findings and insights from the discovery process were summarized in a project brief and presentation." %}
...
{% include project-image.html file="ggb-workshop.jpg" caption="Photos from a one of the stakeholder workshops." %}
...
{% include project-image.html type="grid" file="ggb-user-journey.png" caption="The user journey for the Bridge Customers." %}
...
{% include project-image.html type="grid" file="ggb-design-concepts.jpg" caption="We explored several different design directions for the proejct." %}
...
{% include project-image.html type="grid" file="ggb-route-in-phone.jpg" caption="The bus departure times need to be easily accessible on-the-go."%}
